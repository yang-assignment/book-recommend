...
把账号密码修改为你的
"""
DATABASES_NAME = 'old_book'  # 数据库名称
DATABASES_USER = 'root'  # 数据库用户名，按实际情况填写你的
DATABASES_PASSWORD = '123456'  # 数据库密码，按实际情况填写你的
...
SIMPLEUI_LOGO = 'https://ss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=301625637,2170348995&fm=26&gp=0.jpg'
